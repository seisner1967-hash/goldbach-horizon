...
Improving the cubic envelope, estimating `D(level)` effectively, and the
final Brun-Titchmarsh comparison remain open.
...
above is specifically the audited `TS/Goldbach/Strong/TS15`--`TS148` layer.
